...
const wchar_t* CLogOption::GetOption(const wchar_t* key, const wchar_t* defaultValue)
{
...
int CLogOption::GetOptionAsInt(const wchar_t* key, int defaultValue)
{
...
void CLogOption::AppendField(const wchar_t* key, const wchar_t* val)
{
...
void CLogOption::Append(const CLogOption& opt)
{
